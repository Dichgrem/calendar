...
const strings = {
  ...
  "settings.pwTooShort": { "zh-CN": "新密码至少 4 位", en: "New password must be at least 4 characters" },
  ...
  "settings.serverUrlHint": { "zh-CN": "留空使用当前域名，填入完整地址如 http://192.168.1.100:3000", en: "Leave empty to use current domain, or enter full URL like http://192.168.1.100:3000" },
  ...
  "serverDialog.desc": { "zh-CN": "请输入服务器地址以使用日历应用", en: "Enter server address to use the calendar app" },
  "serverDialog.placeholder": { "zh-CN": "http://192.168.1.100:3000", en: "http://192.168.1.100:3000" },
  "serverDialog.connect": { "zh-CN": "连接", en: "Connect" },
  "serverDialog.skip": { "zh-CN": "稍后设置", en: "Set later" },
  "serverDialog.invalidUrl": { "zh-CN": "请输入有效的 http/https 地址", en: "Please enter a valid http/https URL" },
