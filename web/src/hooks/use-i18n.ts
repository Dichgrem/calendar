...
const strings = {
  ...
  "cal.helpTitle": { "zh-CN": "快捷键", en: "Shortcuts" },
  "cal.helpMonth": { "zh-CN": "切换月份", en: "Switch month" },
  "cal.helpToday": { "zh-CN": "回到今天", en: "Go to today" },
  "cal.helpNewEvent": { "zh-CN": "新建事件", en: "New event" },
  "cal.helpSearch": { "zh-CN": "搜索", en: "Search" },
  "cal.helpShow": { "zh-CN": "显示帮助", en: "Show help" },
  "cal.helpClose": { "zh-CN": "关闭", en: "Close" },
  ...
  "settings.keyboardShortcuts": { "zh-CN": "键盘快捷键", en: "Keyboard shortcuts" },
