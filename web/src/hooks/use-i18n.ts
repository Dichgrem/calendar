...
const strings = {
  ...
  "cal.refresh": { "zh-CN": "刷新订阅", en: "Refresh" },
  "cal.refreshDone": { "zh-CN": "刷新完成", en: "Refreshed" },
  "cal.refreshNonsub": { "zh-CN": "非订阅日历不可刷新", en: "Only subscription calendars" },
  ...
  "settings.autoBackup": { "zh-CN": "备份设置", en: "Backup Settings" },
  "settings.autoBackupCalendars": { "zh-CN": "选择要备份的日历", en: "Select calendars to backup" },
