...
const strings = {
  ...
  "settings.caldav": { "zh-CN": "CalDAV 同步", en: "CalDAV Sync" },
  "settings.caldavUrl": { "zh-CN": "服务器地址", en: "Server URL" },
  "settings.caldavToken": { "zh-CN": "访问令牌", en: "Access Token" },
  "settings.caldavCopied": { "zh-CN": "已复制", en: "Copied" },
  "settings.caldavCopy": { "zh-CN": "复制", en: "Copy" },
  "settings.caldavHint": { "zh-CN": "DAVx5 中填写用户名和密码，与网页登录一致", en: "In DAVx5, use the same username/password as web login" },
