...
export const api = {
  ...
  sources: {
    ...
    courseImport: (data: { icsContent: string; calendarName?: string; color?: string; selectedUids: string[]; overwrite?: boolean; username?: string; password?: string; semester?: string; year?: string }) =>
